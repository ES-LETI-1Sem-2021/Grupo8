...
public class TrelloApi 
{
     ...
     * @return
     * This method returns a String of the project id 
     */
     ...
     * @return
     * This method returns a String of the integral members of the project
     */
     ...
     * @return
     * This method returns a List of the integral members of the project
     */
     ...
     * @return
     * This method returns a String of the starting date
     */
     ...
     * @return
     * This method returns a String which has the interval of time for each sprint 
     */
   ...
   * @return
   * This method returns a String which has accumulated the name of each card for the respective list
   */
 ...
 * @return
 *This method returns a String which has accumulated the name of each card with the label "function" and the respective description 
 */
  ...
  /**
   * Shows the text of the sprints in the cards "SPRINT RETROSPECTIVE" "SPRINT REVIEW" "SPRINT PLANNING" as a String
   * @return
   * This method returns a String which has accumulated the description of each card from these specific lists.
   */
 ...
 * @return
 * This method returns a String which has the sum of all the time spent and the estimated time 
 */
...
/**
 * Shows the spent and estimated time for each Sprint and the total as a double in the appearance of a pieChart
 * @return
 * This method returns a vector of doubles which includes the values of the time spent, estimated time and the total
 */
...
public static double[] horasPrevistasGastas1(Member m) {
	...
	//horasTotal= new[sprint1spent,sprint1estimated,sprint2spent,sprint2estimated,sprint3spent,sprint3estimated,spent,estimated]; 
	return horasTotal;
	
}

public static double custoPorHora() {
	double custo = 20;
	return custo;
